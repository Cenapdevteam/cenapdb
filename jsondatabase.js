...
class JsonDatabase {
    constructor({databasePath = "databases/db.json", maxDataSize = null } = {}) { // the codes here are taken from wio.db
...
module.exports = JsonDatabase; // the codes here are taken from wio.db
